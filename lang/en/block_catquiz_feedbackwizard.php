...
$string['error:feedbackcsvinvalid'] = 'The CSV feedback definition must contain label, lower, upper, and text columns.';
$string['error:feedbackcsvrequired'] = 'Enter CSV feedback rows or switch to another feedback mode.';
...
$string['feedbackdisplaymode:text_and_graphic'] = 'Text and graphic';
$string['feedbackdisplaymode:text_and_scores'] = 'Text and scores';
$string['feedbackdisplaymode:text_only'] = 'Text only';
$string['feedbackmode:csv'] = 'CSV-defined ranges';
$string['feedbackmode:fixed'] = 'Fixed ranges';
$string['feedbackmode:variable'] = 'Variable preset ranges';
$string['feedbackvariablepreset:equal'] = 'Equal-width ranges';
$string['feedbackvariablepreset:focus_high'] = 'Finer differentiation in the upper range';
$string['feedbackvariablepreset:focus_low'] = 'Finer differentiation in the lower range';
...
$string['field:feedbackcsvranges'] = 'CSV range definition';
$string['field:feedbackdisplaymode'] = 'Result display mode';
$string['field:feedbacklabel'] = 'Range {$a} label';
$string['field:feedbacklower'] = 'Range {$a} lower boundary';
$string['field:feedbackmode'] = 'Feedback range mode';
...
$string['field:feedbackvariablepreset'] = 'Variable range preset';
...
$string['message:feedbackcsvtemplate'] = 'CSV example: label,lower,upper,text,templateformat';
...
$string['step04:description'] = 'Define fixed, variable, or CSV-based feedback ranges, choose the reporting strategy, ' .
    'and enter template-ready text for each range.';
...
$string['warning:feedbackcsvempty'] = 'CSV feedback mode is selected, but no CSV range definition has been entered yet.';
