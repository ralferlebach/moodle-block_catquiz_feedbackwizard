...
$string['field:aiinstructions'] = 'Additional wording instructions (optional)';
$string['field:airefinementheader'] = 'AI text refinement';
...
$string['field:useairefinement'] = 'Refine the feedback texts above when continuing';
...
$string['message:airefinementapplied'] = 'AI refinement rewrote {$a} feedback text(s).';
$string['message:airefinementinfo'] = 'Only the feedback texts and your instructions are sent. No names, course data or results are included. Review the result before saving.';
...
$string['warning:aipolicynotaccepted'] = 'You have not accepted the AI policy of this site yet, so the texts are unchanged.';
$string['warning:airefinementplaceholders'] = 'AI refinement dropped placeholders from a feedback text, so the original text was kept.';
$string['warning:airefinementunavailable'] = 'AI refinement was requested but is not available, so the texts are unchanged.';
