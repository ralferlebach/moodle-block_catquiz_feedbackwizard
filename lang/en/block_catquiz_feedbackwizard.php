...
$string['privacy:metadata:block_catquiz_feedbackwizard:datajson'] = 'The partial form data stored as JSON.';
$string['capability:use'] = 'Use multistage form wizard';
$string['step1title'] = 'Step 1: Basic details';
$string['step2title'] = 'Step 2: Content';
$string['step3title'] = 'Step 3: Review & submit';
...
$string['catquiz_feedbackwizard:addinstance'] = 'Add a new Multistage form block';
$string['catquiz_feedbackwizard:myaddinstance'] = 'Add a new Multistage form block to the Dashboard';
$string['catquiz_feedbackwizard:use'] = 'Use multistage form wizard';
