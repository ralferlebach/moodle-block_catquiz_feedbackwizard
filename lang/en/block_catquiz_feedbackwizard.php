...
$string['field:feedbackpreview'] = 'Range {$a} preview';
...
$string['message:feedbacktokenintro'] = 'You can use these placeholders in feedback texts:';
...
$string['token:coursefullname'] = 'Course full name';
$string['token:resultranklabel'] = 'Feedback range label';
$string['token:resultscalename'] = 'Reported scale name';
$string['token:resultscore'] = 'Reported score value';
$string['token:testname'] = 'CAT test name';
$string['token:userfirstname'] = 'User first name';
