...
$string['error:feedbackunknowntoken'] = 'Unsupported placeholder(s): {$a}.';
$string['error:invalidstep'] = 'Invalid wizard step.';
$string['error:matchingcategoryrequired'] = 'Choose the category where the matching rule should be evaluated.';
$string['error:matchingcsvrequired'] = 'Enter at least one CSV matching row.';
$string['error:matchingpatternrequired'] = 'Enter a matching pattern.';
$string['error:matchingtargetrequired'] = 'Enter the target identifier for the matching rule.';
...
$string['field:matchingcsvdefinition'] = 'CSV matching definitions';
$string['field:matchingmode'] = 'Matching mode';
$string['field:matchingoperator'] = 'Match operator';
$string['field:matchingpattern'] = 'Pattern';
$string['field:matchingsummary'] = 'Matching';
$string['field:matchingtargettype'] = 'Target type';
$string['field:matchingtargetvalue'] = 'Target identifier';
$string['field:minquestioncount'] = 'Minimum question count';
$string['field:precisionmode'] = 'Precision';
$string['field:previewtext'] = 'Range {$a} preview';
...
$string['matchingcoursefield:fullname'] = 'Course fullname';
$string['matchingcoursefield:idnumber'] = 'Course ID number';
$string['matchingcoursefield:shortname'] = 'Course shortname';
$string['matchingmode:csv'] = 'Define matching from CSV rows';
$string['matchingmode:none'] = 'Do not configure matching yet';
$string['matchingmode:rules'] = 'Create one matching rule';
...
$string['message:feedbacktokeninfo'] = 'Supported placeholders: {$a}.';
...
$string['message:reviewsummary'] = 'Review the normalised CAT settings, feedback ranges, '
    . 'matching setup, and reporting setup before writing them back to the selected test.';
...
$string['reporting:subscales_with_parents_without_main'] = 'Report selected subscales and their direct parent '
    . 'scales without the main scale';
...
$string['step04:description'] = 'Define fixed feedback ranges, choose the reporting strategy, and enter '
    . 'template-ready text for each range.';
$string['step04:title'] = 'Configure feedback ranges';
$string['step05:description'] = 'Choose whether matching should be configured via a rule or via CSV style definitions.';
...
$string['warning:feedbackunknowntokens'] = 'At least one feedback text contains unsupported placeholders: {$a}.';
$string['warning:highprecisionlowquestions'] = 'High precision usually needs a higher maximum question count.';
$string['warning:matchingincomplete'] = 'The configured matching settings are incomplete.';
