...
$string['status:finished-header']   = 'CAT quiz feedbacks all set up';
$string['status:finished-text']     = 'All feedbacks for the selected CAT quizzes have been successfully set up.
...
$string['status:ready-text']        = 'Let\'s start with setting up fantastic feedbacks for them!';
